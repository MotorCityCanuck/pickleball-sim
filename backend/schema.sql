...
CREATE TABLE teams (
	...
	CONSTRAINT chk_team_type CHECK (team_type IN ('competitive', 'ad_hoc')),
	CONSTRAINT chk_team_division CHECK (team_division IN ('mens_doubles', 'womens_doubles', 'mixed_doubles', 'open_doubles')),
