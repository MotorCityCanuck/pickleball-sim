...
def _seed_old_generated_data(session):
    statements = [
        ...
        "INSERT INTO student_dataset_release_files (id, release_id, table_name, file_path, created_at) VALUES (1, 1, 'player_master', '/tmp/release/player_master.parquet', CURRENT_TIMESTAMP)",
